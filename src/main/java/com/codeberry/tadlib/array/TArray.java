...
public class TArray {
    ...
    public TArray(double[][] values) {
        this(PreparedData.prepareData(values));
    }
    ...
    public TArray(PreparedData preparedData) {
        this.data = preparedData.data;
        this.shape = preparedData.shape;
    }
    ...
    private static class PreparedData {
        ...
        private PreparedData(double[] data, Shape shape) {
            this.data = data;
            this.shape = shape;
        }

        private static PreparedData prepareData(Object array) {
            Shape shape = toShape(array);
            double[] data = shape.toDataArray(array);

            return new PreparedData(data, shape);
        }
