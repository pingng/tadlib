__kernel void tensorAddScalar(__global const double *A, double scalar, long len,
                              __global double *C) {
...
__kernel void singleElementAdd(__global const double *A, __global const double *B, __global double *C) {
    C[0] = A[0] + B[0];
}

__kernel void arrayAdd(__global const double *A, __global const double *B, long len,
                        __global double *C) {
    size_t i = get_global_id(0);
...
__kernel void tensorAdd(__global const double *A,
