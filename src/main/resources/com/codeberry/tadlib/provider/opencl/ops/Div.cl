__kernel void tensorDivScalar(__global const double *A, double scalar, long len,
                              __global double *C) {
...
__kernel void singleElementDiv(__global const double *A, __global const double *B, __global double *C) {
    C[0] = A[0] / B[0];
}

__kernel void arrayDiv(__global const double *A, __global const double *B, long len,
                        __global double *C) {
    size_t i = get_global_id(0);
...
__kernel void tensorDiv(__global const double *A,
