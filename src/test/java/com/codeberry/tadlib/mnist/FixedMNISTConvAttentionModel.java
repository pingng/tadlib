...
public class FixedMNISTConvAttentionModel implements Model {
    ...
    private static class BatchNormLayer {
        ...
        public final OpsExtended.BatchNormRunningAverages bnAverages = new OpsExtended.BatchNormRunningAverages();
    ...
    public PredictionAndLosses calcCost(Random rnd,
                                        Batch trainingData, IterationInfo iterationInfo) {
...
//                    debugPrintMask("Scaled Mask", scaledMask, true);
    ...
    abstract static class PositionEncoder {
        public static NDArray create2dPositionEncoding(int totalChannels, int size) {
            ...
            NDArray encoding = createPositionEncoding(totalChannels / 2, size);
            //        System.out.println("encoding = " + encoding);

            NDArray horizontal = encoding.mul(onesShaped(size, 1, 1));
            ...
            return horizontal.concat(vertical, -1);
        }
