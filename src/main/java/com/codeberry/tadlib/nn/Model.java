...
public interface Model {
    ...
    PredictionAndLosses calcCost(Random rnd, Batch trainingData, IterationInfo iterationInfo);

    default PredictionAndLosses calcGradient(Random rnd, Batch trainingData, IterationInfo iterationInfo) {
        resetGradients();
    ...
    default List<NDArray> getGradients() {
        ...
        List<NDArray> grads = new ArrayList<>(params.size());
        for (Tensor p : params)
            grads.add(p.grad());
